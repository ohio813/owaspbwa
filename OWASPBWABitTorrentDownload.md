In addition to the SourceForge downloads page for the OWASPBWA VM at http://sourceforge.net/projects/owaspbwa/files/, the VM is also available via BitTorrent using [BurnBit](http://burnbit.com).
